...
# Renumber headings if we inserted a new section before Core Terms.
# The draft uses numbered level-2 headings. Keep this lightweight and specific.
...
if "C4 defines the abstract graph-semantic model." not in text:
    ...
    replacement = """C4 defines the abstract graph-semantic model.
...
echo
echo "Diff:"
git diff --   specs/fish/fish_specification_draft.md   specs/fish/purple_herring_http_binding_draft.md   specs/fish/fish_tank_backend_roadmap.md
