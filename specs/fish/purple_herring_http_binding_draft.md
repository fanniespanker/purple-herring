...
This asks for values of `$x` such that the relator phrase `is { $x } of` relates `#/Diane` to `#/Andrea` under the `/fish-srv/characters/` graph root.
...
## 20. Carrier Encodings and Address Forms
...
## 22. Non-Normative Culinary Notes
